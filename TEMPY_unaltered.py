...
Section_ID = '31'
Thermo_depth = [0.012, 0.024, 0.052, 0.064, 0.076, 0.088, 0.101, 0.152, 0.305, 0.457] # reserve for 10 thermocouples
...
file_path = r"C:\wrdapp\Tempy\MnROAD"
...
post_process = 'False' # run postprocess or not, True or False
Ucode = 'True' # this is used to run the sensitivity analysis for delta_e_1 and delta_e_6
...
for time in range(1, t_total + 1):  # need to run "t_total+1"  ; test case for 24 hours
    ...
    Q_solar = solar_sheet.cell(time + 1, 5).value  # get short_wave surface (W/m2);
